...
function App() {
  ...
  {
    text: "Hi, I am Cod3rGPT, a State-of-the-art language model develop by Sanjeev Jaiswal",
    isBot:true,
...
const handleQuery = async (e) => {
  ...
  return (
    ...
    <div className="upperSide">
     <div className="upperSideTop"><img src={gptLogo} alt="Logo" className="logo" /><span className="brand">COD3RGPT</span></div>
    ...
    <div className="main">
          ...
          <div className="chatFooter">
            ...
            <p>COD3RGPT may produce incorrect or inefficient solutions to coding problems</p>
          </div>
